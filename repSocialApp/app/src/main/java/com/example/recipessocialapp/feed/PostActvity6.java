...
import com.example.recipessocialapp.databinding.ActivityPost6Binding;
...
public class PostActvity6 extends AppCompatActivity {
    private ActivityPost6Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPost6Binding.inflate(getLayoutInflater());
        ...
        user1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PostActvity6.this,  UserProfileActivity.class));
            }
        });
