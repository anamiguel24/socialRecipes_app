...
import com.example.recipessocialapp.databinding.ActivityPost7Binding;
...
public class PostActvity7 extends AppCompatActivity {
    private ActivityPost7Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPost7Binding.inflate(getLayoutInflater());
        ...
        user1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PostActvity7.this,  UserProfileActivity.class));
            }
        });
